...
| **Rulebook** | 175 rules (89 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **175** live rules: **89** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
