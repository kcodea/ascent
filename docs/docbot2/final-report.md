...
| **Rulebook** | 167 rules (81 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **167** live rules: **81** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
