 ...
 *
 * Kept as the equivalence ORACLE for `choreo/compile.ts` (`compileMoments` re-implements this algorithm on
 * purpose) — do not dedupe one into the other, or the equivalence tests become tautological.
 */
