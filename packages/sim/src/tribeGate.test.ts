...
const WORD: Record<Exclude<Tribe, 'neutral'>, RegExp> = {
  ...
  // The Starform is the Celestials' token (set 3, 2026-09-12), so a Starform rune counts as naming Celestials — the Imp rule.
  dwarf: /\bDwarv(?:es)?\b|\bDwarf\b/i, kobold: /\bKobolds?\b/i, spirit: /\bSpirits?\b/i, celestial: /\bCelestials?\b|\bStarforms?\b/i,
};
