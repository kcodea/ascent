...
| **Rulebook** | 162 rules (76 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **162** live rules: **76** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
