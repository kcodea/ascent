...
/**
 * DEV-only floating tuner for the three CARD PILLS (`cardPillsConfig.ts`) — the cost coin, the Tier badge and
 * the Spell/Ruby type pill. Each gets its own x/y/scale so they can be seated INDEPENDENTLY (owner ask
 * 2026-07-24); nothing here is shared between the three.
 *
...
export function CardPillsTuner() {
  ...
  const set = (k: keyof CardPillsConfig, v: number): void => {
