...
| **Rulebook** | 166 rules (80 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **166** live rules: **80** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
