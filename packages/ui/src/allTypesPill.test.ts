...
const ART_PENDING = new Set<string>([
  ...
  'dw3_tankerchief',
  // SET 3 UNDEAD (2026-09-09): ten of the eleven new Undead shipped with masters; the Hierophant's is owed
  // (only un-named UUID files remain in the Undead masters folder). Anubis, Last Gate reuses Anubis's art.
  'u3_hierophant',
