...
| **Rulebook** | 159 rules (73 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **159** live rules: **73** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
