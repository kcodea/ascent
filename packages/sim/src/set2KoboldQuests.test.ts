...
describe('Gem Circuit — the first-N Ruby window (the Resonance rune left it for "every Ruby casts twice", 2026-09-24)', () => {
  it('Gem Circuit keeps its 1-Ruby window (widest window wins, bonuses stack)', () => {
    const s: RunState = { ...set2(), rubyFirstExtraCasts: 3, rubyFirstCastWindow: 2 };
  ...
  // Rune of Resonance itself ("Your Rubies cast twice from hand. Start of Turn: get a random Ruby.", owner Ruby
  // batch 2026-09-24) is pinned in rubyTypes.test.ts.
});
