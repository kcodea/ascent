...
- Anomaly oracle: 3 questions above the confidence floor; 24 suppressed below it.
...
| Sitting 2 — interactions | 3 | `npm run docbot:interactions` |
...
- **50** vitest lane files under `packages/sim/src/docbot/`.
...
| 14 | Mutation/sabotage tests demonstrate detection in every oracle family | **partial** | 25 of 50 docbot lanes carry an in-file sabotage proof, plus the retro harness's 14 reinjections; the remaining lanes are structural ratchets without one |
...
10. **Half the lanes lack a sabotage proof.** 25 of 50. An oracle that has never been shown to fail is an
