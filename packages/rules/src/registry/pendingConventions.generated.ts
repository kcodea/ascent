...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "title": "'echo' family · 62 cards",
    "statement": "All 62 'echo' cards trigger the same way. Gilding doubles their output; a few summon a gilded token instead. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "46 effect factories across 62 cards dispatch through the 'echo' presentation family, all on the single trigger 'onDeath' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline is the safe reading, with Void Panther / T-Rex / Chicken Brawl gilding the token they summon instead of doubling the count (owner ruling 2026-08-28).",
    "cardText": "Exemplar — Amun Rab: \"Deathrattle: Summon 7 Imps and give your Imps +5/+5.\" · Members: Amun Rab · Anubis, Last Gate · Ashen Heir · Armadiyo · Bullseye · Dawnclaw · Menagerie Mammoth · T-Rex · Voidmother · Wolvie · Blaster · Bone Taxer · … and 50 more",
  ...
  },
  {
    ...
    "title": "'endOfTurn' family · 26 cards",
    "statement": "All 26 'endOfTurn' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "32 effect factories across 26 cards dispatch through the 'endOfTurn' presentation family, all on the single trigger 'endOfTurn' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Abyssal Feeder: \"End of Turn: adjacent minions each Consume a Fodder.\" · Members: Abyssal Feeder · Aeon Guard · Moira · Stonehorn Archivist · Combinator · Crypt Scribe · Skybound Ascendant · Soul Defiler · Bob Blart · Striker · Arnold · Brunni · … and 14 more",
  ...
  },
  {
    ...
    "title": "'grant' family · 11 cards",
    "statement": "All 11 'grant' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "1 effect factories across 11 cards dispatch through the 'grant' presentation family, all on the single trigger 'equip' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Pourman: \"Equip Pourman's Keg (1): cast a random Dwarven Ale.\" · Members: Pourman · Thymes · Alchemist Frank · Titan Sculptor · Blast Surveyor · Kaura L'roft · Prismpick Artificer · Highway Hustler · Inspector Pell · EMS · Robinson",
  ...
  },
  {
    ...
    "title": "'rally' family · 42 cards",
    "statement": "All 42 'rally' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "43 effect factories across 42 cards dispatch through the 'rally' presentation family, all on the single trigger 'onAttack' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Echohorn: \"Rally: trigger your left-most Echo.\" · Members: Echohorn · Hawkus · Packstrider · Sunmane Herald · Chimerus · Chorus Engine · Crypt Drake · Chorus Drake · Cinderchef · Embercrest · Flamebeat Drake · Roarcollector · … and 30 more",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "310 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
  ...
  },
  {
    ...
    "cardText": "Exemplar — Echohorn: \"Rally: trigger your left-most Echo.\" · Carriers: Echohorn · Packstrider · Sunmane Herald · Better Bot · Chimerus · Chorus Engine · Chorus Drake · Cinderchef · Embercrest · Flamebeat Drake · Roarcollector · Deathsayer · … and 21 more",
  ...
  },
  {
    ...
    "id": "q-conv-keyword-t",
    "title": "Taunt [T] · 19 carriers",
    "statement": "Taunt means: enemies must attack your Taunt minions before anything else — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "keywords",
    "currentBehaviour": "One shared engine path implements Taunt for all 19 carriers.",
    "cardText": "Exemplar — Armadiyo: \"Taunt. Echo: give your Beast Aura +2/+4.\" · Carriers: Armadiyo · Dawnclaw · Wolvie · Blaster · Fel Spikes · Chipper · Knocked · Big Huggies · Brunni · Twilight Emissary · Gryphon · Geode Guardian · … and 7 more",
  ...
  },
  {
    ...
    "title": "Trigger: a friendly minion gains Attack · 4 cards",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "11 effect factories across 10 cards dispatch on 'minionSold', 'onSell' (recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — River Drake: \"When you sell this, get a random Spell.\" · Members: River Drake · Voicekeeper · Arcane Behemoth · Grevlin & Co. · Shift Broker · Hoard Whelp · Beggy · Cheap Date · Traveling Salesman · Salvatore McKlusky",
  ...
  },
  {
    ...
    "cardText": "Exemplar — Fel Conjurer: \"Start of Turn: get a Quick Study.\" · Members: Fel Conjurer · Dealer · Equipment Charger",
