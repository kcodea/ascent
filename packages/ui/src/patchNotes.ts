    ...
    changes: [
      {
        ...
        details: [
          ...
          "Dropping OUT of a medal is gated too: a loss at a medal's lowest division (Gold III) stops at 0 and your next ranked game is a DEMOTION GAME — a top-4 finish keeps you in the medal (your points apply from 0), a 5th–8th drops you to the previous medal's division I with 100 minus that game's loss (an 8th lands on Silver I 60).",
