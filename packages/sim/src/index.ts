...
export { recurringTickCount, RUNE_ACTION_GRANT } from './recruit'; // Rune of Action REPEAT form (owner 2026-09-25): the badge reads the commit's tick count
...
export { coverageKeysFor, buildCoverageCorpus, corpusDigest, CORPUS_CONFIG, driveTrajectory, minimizeFailure, specToScenario, scenarioRepro, violationPredicate, makeFinding, fingerprintFinding, emitFindingsJson, runNightly, nightlyReportJson, DEFAULT_NIGHTLY, NIGHTLY_ACKS, nightlyVerdict, describeAck, buildNightlyStatus, formatNightlyStatus, LOCAL_NIGHTLY_STATUS_PATH, type NightlyAck, type NightlyVerdict, type NightlyStatus, type NightlyStatusFinding, type CorpusBuildResult, type CorpusEntry, type NightlyConfig, type NightlyReport, type DocbotFinding } from './docbot';
...
export { addBuff, boardManaBonus, cardBuff, conjuredStats, dragonTamerCostOf, roundedSpellbookCostOf, buyoutCostOf, heroPowerCostOf, allInPayoutOf, exhibitionGrantOf, tempestGrantOf, bladeMasteryGrantOf, hoardWhelpStatsOf, TEMPEST_KILLS_PER_STEP, BLADE_ATTACKS_PER_STEP, heroPowerText, CIA_SUIT_TEXT, COMMISSION_TEXT, COMMISSION_NAME, COMMISSION_REWARD, commissionOffer, aegisGrantOf, COMMISSION_DELAY, threeDistinctTypes, stampSableBond, heroOfferPrice, endOfTurnRepeats, eotTickCount, endOfTurnTicksOf, isTribe, defIsTribe, magnetizeTargets, modalOpen, chooseBothActive, chooseBothStateOf, spendChooseBothCharge, type ChooseBothState, chooseOneNeedsChoice, offerBuyStats, projectEndOfTurnSteps, questEndOfTurnBeats, sellValueOf, sellValueWithBonus, spellCasts, runeExtraCasts, rubyCastCount, giftCastCount, spellCostReduction, isStatSpell, isStatGrantingSpell, castSpellWithoutAim, implosionCasts, dragonflameCasts, spiritsPlayedThisTurn, playedThisTurnFor, tribesPlayedThisTurn, revelerValue, REVELER_METER, ENDLESS_MARCH_TOKEN, anySpellsCastThisTurn, spellDisplayText, chooseOneBranchText, chooseOneBranchTextFor, effectFoldsSpellPower, isStatSpellFactory, dominantBoardTribe, gildMinion, effectiveTargetTribe, spellStatBonus, spellAttackBonus, spellHealthBonus, spellAttackBonusLive, spellHealthBonusLive, spellEscalationLive, rubyStatBonus, undeadBuyBonus, pickShopMinionFor, buffThisShopOffers, primeExtraPrimaryLands, type EotStepFx } from './recruit';
