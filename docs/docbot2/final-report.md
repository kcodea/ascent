...
| **Rulebook** | 185 rules (99 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **185** live rules: **99** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
