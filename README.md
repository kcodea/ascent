...
- **The locked third rune slot wears chains** — most runs only get 2 runes (forge turns 6 & 9), so the third slot shows chains from the start as "not possible yet." They lift for heroes/runes that unlock a 3rd (Runesmith, Guardian, Rune of the Epic Forge, Rune of Duplication). Position/size tunable in the 💠 Rune Sheen tuner.
