...
- **Cleave rakes, Growth blooms.** A Cleave attacker now throws one volley of claw streaks across every unit
  it hits, replacing the per-victim burst; casting Growth sends tendrils sweeping from the centre of the board
  out to both ends, shedding leaves and petals — in the shop and in combat alike. Both have DEV tuner panels.
