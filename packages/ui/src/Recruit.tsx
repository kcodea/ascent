...
function offerLiveTextParams(golden: boolean, o: ShopViewOpts, cardId?: string): LiveTextParams {
  return {
    ...
    revelerX: o.revelerX, spiritsPlayed: o.spiritsPlayed, clueBonus: o.clueBonus, anySpellsThisTurn: o.anySpellsThisTurn,
