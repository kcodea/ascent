...
export const TOKENS: CardDef[] = [
  ...
  {
    // Twilight Whelp's Deathrattle cub — a 3/2 Dragon that ATTACKS IMMEDIATELY when summoned (out of turn
  ...
  // --- Mech/neutral quest rewards (2026-07-08). token: true → reward-only. ---
  {
    ...
    text: '**Ward**, **Magnetic** (attach to any minion). **Rally:** get a random Shop spell.',
    goldenText: '**Ward**, **Magnetic** (attach to any minion). **Rally:** get **2** random Shop spells.',
    token: true,
  },
];
