...
| **Rulebook** | 164 rules (78 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **164** live rules: **78** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
