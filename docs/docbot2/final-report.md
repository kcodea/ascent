...
| **Rulebook** | 165 rules (79 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **165** live rules: **79** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
