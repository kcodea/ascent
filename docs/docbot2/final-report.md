...
| **Rulebook** | 161 rules (75 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **161** live rules: **75** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
