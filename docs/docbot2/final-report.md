...
| **Rulebook** | 180 rules (94 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **180** live rules: **94** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
