...
|---|---|
| derived status **corroborated** (two independent sources agree — trace + text, or trace + params) | 363 |
...
**523 unresolved parses is the honest headline of this section.** They are classified, queued, ratcheted
...
- Graph: **1546** nodes / **4692** edges over the contract registry (content, effect-family, trigger-family,
  channel, keyword, multiplier, copy-mode, counter, zone, phase-boundary nodes).
- Applicability: **89819** candidate pairs against 406351 naive all-pairs (21.9%) — the producer → channel →
