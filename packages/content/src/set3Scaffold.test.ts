...
describe('set 3 scaffold', () => {
  it('holds the Equip minions, the carried-over Kobolds, and the shared neutral spell toolkit', () => {
    ...
    expect(p.buyable.map((c) => c.id)).toEqual([
      ...
      // …then the UNDEAD (owner roster 2026-09-09): set 3's eleven new ones (+ Bicycle Ben, 2026-09-18), then the ten set-1 Undead it keeps
      ...
      'u3_bicycleben', // the twelfth new Undead (owner handoff 2026-09-18), appended after the file's token
    ...
    expect(p.spells.length).toBe(62); // 40 neutral toolkit (Common Ground out 2026-09-14, Gamble in 2026-09-17) + 7 tribe spells + 5 Ales + 9 set-3 spells (owner sheet 2026-09-10) + Black Hole (Accretion, 2026-09-12)
