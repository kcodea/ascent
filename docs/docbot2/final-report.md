...
| **Rulebook** | 163 rules (77 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **163** live rules: **77** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
