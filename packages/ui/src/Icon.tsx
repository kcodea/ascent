...
const ICONS: Record<string, ReactNode> = {
  ...
  // OVERFLOW — a brimming vessel: a cup outline with a wave cresting past its rim (a summon that finds no room).
  overflow: (
    <>
      <path fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" d="M5 9v7a4 4 0 004 4h6a4 4 0 004-4V9" />
      <path fill="currentColor" d="M3.5 9c1.4-1.6 2.8-2.4 4.25-2.4S10.6 7.4 12 9c1.4-1.6 2.8-2.4 4.25-2.4S19.1 7.4 20.5 9v3.2c-1.4-1.6-2.8-2.4-4.25-2.4S13.4 10.6 12 12.2c-1.4-1.6-2.8-2.4-4.25-2.4S4.9 10.6 3.5 12.2V9z" />
      <path fill="currentColor" d="M9.2 4.6l1.7-2.2 1.1 2.7-1.7.2z" opacity="0.7" />
    </>
  ),
