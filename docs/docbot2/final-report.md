...
| 14 | Mutation/sabotage tests demonstrate detection in every oracle family | **partial** | 26 of 51 docbot lanes carry an in-file sabotage proof, plus the retro harness's 14 reinjections; the remaining lanes are structural ratchets without one |
...
10. **Half the lanes lack a sabotage proof.** 26 of 51. An oracle that has never been shown to fail is an
