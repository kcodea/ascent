...
| **Rulebook** | 172 rules (86 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **172** live rules: **86** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
