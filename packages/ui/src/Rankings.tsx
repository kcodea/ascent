...
export function Rankings() {
  ...
  const [noReplay, setNoReplay] = useState<string | null>(null);  // userId with no watchable run
        ...
        {!remoteEnabled() ? (
          ...
          <div className="ranktable">
            ...
            {rows.map((r, i) => {
              ...
              // Watch their latest run — fetch that player's newest replay and hand it to the viewer. startReplay
              // closes this overlay, so exiting the replay returns to the title.
