...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "8 effect factories across 9 cards dispatch through the 'castReact' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "statement": "All 36 'economy' cards trigger the same way. 1 are spells, which never gild; the other 35 double their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "21 effect factories across 36 cards dispatch through the 'economy' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: 1 members are spells or Rubies and can never BE gilded (R-GILD-02, owner ruling 2026-08-28) — their gilding aspect is inapplicable, not unprobed; the remaining 35 inherit the ×2 baseline.",
    ...
    "example": "Moonhowl Mentor follows the 'economy' convention — its trigger fires on cardsBought. three copies of a spell never combine into a golden one, so most of this family has no gilded form at all.",
    "contentIds": [
      "b2_moonhowl",
      "buddy",
      "c3_courier",
  ...
  },
  {
    ...
    "statement": "All 14 'economyReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "14 effect factories across 14 cards dispatch through the 'economyReact' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Korok, the Hungerer follows the 'economyReact' convention — its trigger fires on cardsBought. its printed numbers double when the card is gilded.",
    "contentIds": [
      "acid",
      "banksly",
      "broker",
  ...
  },
  {
    ...
    "statement": "All 45 'endOfTurn' cards trigger the same way. 1 are spells, which never gild; the other 44 double their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "31 effect factories across 45 cards dispatch through the 'endOfTurn' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: 1 members are spells or Rubies and can never BE gilded (R-GILD-02, owner ruling 2026-08-28) — their gilding aspect is inapplicable, not unprobed; the remaining 44 inherit the ×2 baseline.",
    ...
    "example": "Abyssal Feeder follows the 'endOfTurn' convention — its trigger fires on endOfTurn. three copies of a spell never combine into a golden one, so most of this family has no gilded form at all.",
    "contentIds": [
      "abyssalfeeder",
      "aeonguard",
      "b2_moira",
  ...
  },
  {
    ...
    "statement": "All 15 'orbit' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "12 effect factories across 15 cards dispatch through the 'orbit' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Constellation Broker follows the 'orbit' convention — its trigger fires on orbit. its printed numbers double when the card is gilded.",
    "contentIds": [
      "c3_broker",
      "c3_cartographer",
      "c3_channeler",
  ...
  },
  {
    ...
    "statement": "All 3 'orbitReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "3 effect factories across 3 cards dispatch through the 'orbitReact' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Orrery, World Devourer follows the 'orbitReact' convention — its trigger fires on orbitFired. its printed numbers double when the card is gilded.",
    "contentIds": [
      "c3_orrery",
      "c3_shopkeeper",
      "c3_weaver"
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "2 effect factories across 2 cards dispatch through the 'passive' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "statement": "All 45 'rally' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "41 effect factories across 45 cards dispatch through the 'rally' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "statement": "All 12 'react' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "10 effect factories across 12 cards dispatch through the 'react' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Avarice Incarnate follows the 'react' convention — its trigger fires on friendlyDemonDealtDamage. its printed numbers double when the card is gilded.",
    "contentIds": [
      "dm_avarice",
      "dm_chosenfiend",
      "dm_jumbo",
  ...
  },
  {
    ...
    "statement": "All 71 'shout' cards trigger the same way. 3 are spells, which never gild; the other 68 double their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "48 effect factories across 71 cards dispatch through the 'shout' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: 3 members are spells or Rubies and can never BE gilded (R-GILD-02, owner ruling 2026-08-28) — their gilding aspect is inapplicable, not unprobed; the remaining 68 inherit the ×2 baseline.",
    ...
    "example": "Aeon Guard follows the 'shout' convention — its trigger fires on onPlay. three copies of a spell never combine into a golden one, so most of this family has no gilded form at all.",
    "contentIds": [
      "aeonguard",
      "alley",
      "b2_magepup",
  ...
  },
  {
    ...
    "statement": "All 3 'shoutPayoff' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "2 effect factories across 3 cards dispatch through the 'shoutPayoff' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Combinator follows the 'shoutPayoff' convention — its trigger fires on battlecryTriggered. its printed numbers double when the card is gilded.",
    "contentIds": [
      "combinator",
      "d2_grimoire",
      "reconfiguredcombinator"
  ...
  },
  {
    ...
    "statement": "All 6 'shoutReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "4 effect factories across 6 cards dispatch through the 'shoutReact' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "5 effect factories across 5 cards dispatch through the 'slaughter' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "statement": "All 106 'spellCast' cards trigger the same way. 99 are spells, which never gild; the other 7 double their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "91 effect factories across 106 cards dispatch through the 'spellCast' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: 99 members are spells or Rubies and can never BE gilded (R-GILD-02, owner ruling 2026-08-28) — their gilding aspect is inapplicable, not unprobed; the remaining 7 inherit the ×2 baseline.",
    ...
    "example": "Anomaly Reactor follows the 'spellCast' convention — its trigger fires on cast. three copies of a spell never combine into a golden one, so most of this family has no gilded form at all.",
    "contentIds": [
      "anomalyreactor",
      "aresmar",
      "bloodlust",
  ...
  },
  {
    ...
    "statement": "All 23 'startOfCombat' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "22 effect factories across 23 cards dispatch through the 'startOfCombat' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "13 effect factories across 13 cards dispatch through the 'summonReact' presentation family; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "320 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
