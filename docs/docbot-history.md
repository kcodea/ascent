# Doc Bot — the build history (archived 2026-09-11)

> **This is the narrative history of how each lane came to exist, kept for the record.** The two-page contract
> — what gates, what runs nightly, what is dormant, how to read a failure — is [`docbot.md`](docbot.md).

## The standing correctness auditor (original preamble)
