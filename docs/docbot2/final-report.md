...
| **Rulebook** | 173 rules (87 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **173** live rules: **87** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
