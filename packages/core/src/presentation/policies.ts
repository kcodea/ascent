...
export const PRESENTATION_POLICIES: Record<string, PresentationPolicyEntry> = {
  ...
  'factory:onGainStatsBuffRandomHand:onGainStats': { policy: 'ownBeat', family: 'react' }, // Handy Flame (Set 3 batch 2, 2026-09-16)
  ...
  // Flagrunner's Rally grant and Prismpick's first branch — a card arriving in hand is its own moment.
  'factory:grantRandomChooseOne:onAttack': { policy: 'ownBeat', family: 'rally' },
  // Dealer arms a run flag at the start of the turn — nothing lands on the board to animate.
  ...
  // DEALER arms her own latch — on arrival and again each turn. Nothing lands on the board either way (the
  // charge is a promise about the NEXT card played), so there is no consequence to animate and no beat to
  // give it: `passive`, the same shape the run-level charge below carries. `economy`, not the `passive`
  // family, because a `passive` family here dissolves an owner-approved convention question — the clusters
  ...
  'factory:spellBuffTargetPerSpellsCast:cast': { policy: 'ownBeat', family: 'spellCast' },
  'factory:spellDiscoverMinion:cast': { policy: 'ownBeat', family: 'spellCast' },
  'factory:spellDiscoverShopSpell:cast': { policy: 'ownBeat', family: 'spellCast' },
  ...
  'rune:rune_dreamed_graves:combat': { policy: 'foldedCue', family: 'combatModifier' },
  ...
  'rune:rune_grand_workshop:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  ...
  'rune:rune_final_gate:combat': { policy: 'foldedCue', family: 'combatModifier' },
  ...
  // ── Set 3 batch 2 (2026-09-16) — tranche A (Spirit / Celestial / Undead runes) ──
  ...
  'rune:rune_growing_chorus:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_charted_skies:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_falling_embers:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_festival_wages:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_epic_celestial:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_epic_spirit:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_epic_undead:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_meteor_shower:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_astral_refrain:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_astral_draft:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  ...
  'rune:rune_spirit_crown:recruit': { policy: 'ownBeat', family: 'runeMechanic' },
  'rune:rune_handy_flame:onAcquire': { policy: 'ownBeat', family: 'rewardGrant' },
  ...
  // combat) stamped with these keys, and the replay plays the owner's `pummel-trigger` flash INSIDE the hit's impact
