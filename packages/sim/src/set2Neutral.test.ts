...
describe('set 2 — its own neutral minions are wired into the set', () => {
  ...
  it('match the roster tier/stats', () => {
    ...
    expect(spec('n2_bellringer')).toBe('T4 4/4'); // owner balance 2026-08-18: T5 4/6 → T4 2/3; 2026-09-18: → 4/4
    expect(spec('n2_lastlight')).toBe('T3 3/2'); // owner balance 2026-08-18: T4 → T3
  });
});
