...
export const QUEST_DEFS: QuestDef[] = [
  ...
  { id: 'q_pack_mentality', name: 'Pack Mentality', tribe: 'beast', tier: 'greater', objective: { event: 'summonCombat', count: 5, tribe: 'beast' }, reward: { kind: 'scalingTribeAura', tribe: 'beast', attack: 4, health: 4, per: 5, event: 'summonCombat', stepAttack: 4, stepHealth: 4 } },
  ...
  { id: 'q_forsaken_will', name: 'Forsaken Will', tribe: 'undead', tier: 'greater', objective: { event: 'summonCombat', count: 6, tribe: 'undead' }, reward: { kind: 'undeadSpellAura', attack: 6 } },
  ...
  { id: 'q_pivot_door', name: 'The Pivot Door', tribe: 'neutral', tier: 'greater', objective: { event: 'spendGold', count: 13 }, reward: { kind: 'grant', cards: ['lazarus'] } },
  { id: 'q_merchants_mark', name: "Merchant's Mark", tribe: 'neutral', tier: 'greater', objective: { event: 'spendGold', count: 40 }, reward: { kind: 'minionCost', cost: 2 } },
