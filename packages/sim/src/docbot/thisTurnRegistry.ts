...
export const THIS_TURN_CLASSIFIED: Readonly<Record<string, ThisTurnClassification>> = {
  ...
  u3_bicycleben: { kind: 'conforms', why: 'overflow grant improves per Undead played this turn — threaded as the per-tribe combatSide.tribesPlayed map at the faceOmen build (and on the board snapshot), read via ctx.playedThisTurnFor(side, "undead") through the shop-and-combat arena body (2026-09-18)' },
