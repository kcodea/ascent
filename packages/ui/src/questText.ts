...
const TRIBE_PLURAL: Record<Tribe, string> = { beast: 'Beasts', dragon: 'Dragons', undead: 'Undead', mech: 'Mechs', demon: 'Demons', neutral: 'minions', kobold: 'Kobolds', dwarf: 'Dwarves', celestial: 'Celestials', spirit: 'Spirits' };
const TRIBE_SINGULAR: Record<Tribe, string> = { beast: 'Beast', dragon: 'Dragon', undead: 'Undead', mech: 'Mech', demon: 'Demon', neutral: 'minion', kobold: 'Kobold', dwarf: 'Dwarf', celestial: 'Celestial', spirit: 'Spirit' };
...
const EOT_EFFECT_TEXT: Record<Extract<QuestReward, { kind: 'recurringEndOfTurn' }>['effect'], string> = {
  ...
  runeAction: 'End of Turn: give 3 random friendly minions +2/+2. Repeat for every card played this turn',
