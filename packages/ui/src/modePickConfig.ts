...
export const MODEPICK_VARS: ModePickVarDef[] = [
  ...cardVars('play', 'Play', { s: 0.84, w: 660, h: 284, x: -169, y: 115, artS: 1, artX: 0, artY: 0 }),
  ...cardVars('learn', 'Learn', { s: 1, w: 880, h: 102, x: 196, y: 123, artS: 1.02, artX: 0, artY: 3 }),
  ...cardVars('practice', 'Practice', { s: 0.84, w: 306, h: 284, x: -73, y: -229, artS: 1, artX: 0, artY: 0 }),
  ...
  { key: 'titleY', cssVar: '--mp-title-y', label: 'Y offset', group: 'MODE title', min: -1000, max: 1000, step: 1, def: 155, fmt: 'px' },
];
