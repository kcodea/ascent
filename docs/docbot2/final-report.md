...
| **Rulebook** | 174 rules (88 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **174** live rules: **88** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
