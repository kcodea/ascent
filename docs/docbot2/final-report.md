...
| **Rulebook** | 177 rules (91 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **177** live rules: **91** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
