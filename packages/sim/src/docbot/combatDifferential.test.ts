...
describe('Doc Bot — combat presence differential', () => {
  ...
  it('the unstageable residue is pinned (1 as of 2026-08-26: Reflector — needs a targeted combat cast)', () => {
    ...
    // 3 → 2 on 2026-09-18: Seedling Spirit went 2/3 → 2/4 in the owner's stat pass and its Rally now registers a change
    // in a staged variant, so it is no longer inert (Reflector + Kindled Sprite remain).
    const PIN = 2;
