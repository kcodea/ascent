...
// lightning is OFF (boltRate 0 — the bolt dials below still shape the STRIKE burst, which bypasses the
// rate gate), the glow is a tight 1px-blur rim breathing fast and shallow, and the pressed art ships as
