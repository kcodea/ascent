...
Generated by `npm run rules:seed` — 22 pending rulings from Doc Bot's queues.
...
- **q-policy-passive-hero-powers** — 25 hero powers do nothing when pressed — confirm they are passive/scheduled by design
...
## runeRewardDifferential (1)

- **q-policy-rune-duplicates** — Rune duplicate policy: 80 runes whose second copy does nothing
