...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "title": "'grant' family · 1 card",
    "statement": "The 1 'grant' card triggers the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "1 effect factories across 1 card dispatch through the 'grant' presentation family, all on the single trigger 'equip' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Alchemist Frank: \"Equip Bloodpot (1): Give a friendly minion +3/+3.\" · Members: Alchemist Frank",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "269 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
