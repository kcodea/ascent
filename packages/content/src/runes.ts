...
export const RUNES: RuneDef[] = [
  ...
  },
  {
    ...
    cost: 3, // owner balance 2026-08-04 (tranche 3 of balance 9/23 moves it to 5)
  ...
  },
  {
    ...
    cost: 4, // tranche 3 of balance 9/23 moves it to 5
...
export const EPIC_RUNES: RuneDef[] = [
  ...
  // ── the 2026-08-07 owner Epic batch (14 runes) ──
  {
    ...
    cost: 5, // tranche 3 of balance 9/23 moves it to 2
    epic: true,
