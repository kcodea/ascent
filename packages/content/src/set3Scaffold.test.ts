...
describe('set 3 scaffold', () => {
  it('holds the Equip minions, the carried-over Kobolds, and the shared neutral spell toolkit', () => {
    ...
    expect(p.spells.length).toBe(61); // 39 neutral toolkit (Common Ground out 2026-09-14) + 7 tribe spells + 5 Ales + 9 set-3 spells (owner sheet 2026-09-10) + Black Hole (Accretion, 2026-09-12)
