...
- **Sunmane Herald's rally no longer leaves attackers behind.** It buffs itself along with the rest of your Beasts, so the board escalates in lockstep instead of drifting into unrelated numbers.
