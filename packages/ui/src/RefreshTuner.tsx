...
const SPECS: Record<keyof RefreshConfig, [string, TunerUnit | undefined, string, string]> = {
  ...
  glowW:          ['Width fit', '×', 'Halo width relative to the button.', 'Glow fit'],
  glowH:          ['Height fit', '×', 'Halo height relative to the button.', 'Glow fit'],
  glowRadius:     ['Corner radius', 'px', 'Halo corner rounding. High = a capsule that hugs the pill; 0 = a rectangle.', 'Glow fit'],
