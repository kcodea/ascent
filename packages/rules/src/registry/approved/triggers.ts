...
export const TRIGGERS_RULES: GameRule[] = [
  ...
  },
  {
    ...
    statement:
      ...
      + 'replacing the 2026-09-24 static-text exception): every live surface reads "Echo: Give your Beast Aura +X/+Y." '
      ...
      + 'matching what it pays. The per-Echo rate stays the card\'s rule text (Compendium, Doc Bot) only.',
    domain: 'triggers',
    status: 'approved',
    evidence: [
