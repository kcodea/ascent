...
const UNIT_LESS: { file: string; id: string; why: string }[] = [
  ...
  { file: 'EquipFxTuner.tsx', id: 'bloodpot', why: "the tuner's TEST fire for the USE effect — slot to a stand-in point, no run and no unit; the real call carries the target uid" },
