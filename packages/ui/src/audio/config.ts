...
export const CATEGORY_GAINS: Record<string, number> = {
  ...
  cardEffect: 0.18, cardDeath: 0.18, heroSelect: 0.5, heroPower: 0.5, summon: 0.37, turncharge: 0.5, turnexplosion: 0.5,
};
...
export const CATEGORY_BUS: Record<string, BusName> = {
  ...
  cardlanding: 'ui', castspell: 'ui', triple: 'ui', turncharge: 'ui', turnexplosion: 'ui',
