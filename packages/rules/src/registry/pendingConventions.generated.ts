/**
 * GENERATED by `npm run contracts:extract` — do not hand-edit. 67 convention questions
...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "8 effect factories across 9 cards dispatch through the 'castReact' presentation family, all on the single trigger 'spellCast' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    ...
    "example": "Groveweaver follows the 'castReact' convention — its trigger fires on spellCast. its printed numbers double when the card is gilded.",
    "contentIds": [
      "b2_groveweaver",
      "d2_ashscribe",
      "d2_scalechanter",
  ...
  },
  {
    ...
    "title": "'echo' family · 59 cards",
    "statement": "All 59 'echo' cards trigger the same way. Gilding doubles their output; a few summon a gilded token instead. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "43 effect factories across 59 cards dispatch through the 'echo' presentation family, all on the single trigger 'onDeath' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline is the safe reading, with Void Panther / T-Rex / Chicken Brawl gilding the token they summon instead of doubling the count (owner ruling 2026-08-28).",
    "cardText": "Exemplar — Amun Rab: \"Deathrattle: Summon 7 Imps and give your Imps +5/+5.\" · Members: Amun Rab · Anubis · Ashen Heir · Armadiyo · Bullseye · Dawnclaw · Menagerie Mammoth · Scavvers · T-Rex · Voidmother · Wolvie · Blaster · … and 47 more",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "31 effect factories across 29 cards dispatch through the 'endOfTurn' presentation family, all on the single trigger 'endOfTurn' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Abyssal Feeder: \"End of Turn: adjacent minions each Consume a Fodder.\" · Members: Abyssal Feeder · Aeon Guard · Moira · Stonehorn Archivist · Combinator · Crypt Scribe · Skybound Ascendant · Runefire · Spellvault Drake · Soul Defiler · Bob Blart · Void Curator · … and 17 more",
  ...
  },
  {
    ...
    "title": "'rally' family · 43 cards",
    "statement": "All 43 'rally' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "41 effect factories across 43 cards dispatch through the 'rally' presentation family, all on the single trigger 'onAttack' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Echohorn: \"Rally: trigger your left-most Echo.\" · Members: Echohorn · Hawkus · Packstrider · Sunmane Herald · Badgington · Chimerus · Chorus Engine · Crypt Drake · Ashen Broodlord · Chorus Drake · Cinderchef · Embercrest · … and 31 more",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "48 effect factories across 54 cards dispatch through the 'shout' presentation family, all on the single trigger 'onPlay' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "4 effect factories across 5 cards dispatch through the 'shoutReact' presentation family, all on the single trigger 'battlecryTriggered' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Bane: \"After you trigger a Shout, give your Imps +3/+3 this run.\" · Members: Bane · Embermouth Whelp · Bathing Matriarch · Karwind · Sporeling",
  ...
  },
  {
    ...
    "title": "'startOfCombat' family · 20 cards",
    "statement": "All 20 'startOfCombat' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "22 effect factories across 20 cards dispatch through the 'startOfCombat' presentation family, all on the single trigger 'startOfCombat' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Abhorrent Horror: \"Start of Combat: Gain +Attack/+Health equal to the Fodder consumed this turn.\" · Members: Abhorrent Horror · Arena Heckler · Quil · Runebloom Matriarch · Spots · Bloodbinder · Thunderous Sovereign · Imp Wrangler · Bucky · Drunken Oaf · Grave Body · Gravewarden · … and 8 more",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "300 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
  ...
  },
  {
    ...
    "title": "Rally [RL] · 33 carriers",
    "statement": "Rally means: triggers its effect each time this minion attacks — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "keywords",
    "currentBehaviour": "One shared engine path implements Rally for all 33 carriers.",
    "cardText": "Exemplar — Echohorn: \"Rally: trigger your left-most Echo.\" · Carriers: Echohorn · Packstrider · Sunmane Herald · Badgington · Better Bot · Chimerus · Chorus Engine · Ashen Broodlord · Chorus Drake · Cinderchef · Embercrest · Flamebeat Drake · … and 21 more",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "7 effect factories across 7 cards dispatch on 'cardsBought', 'onBuy', 'spellBought' (recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Korok, the Hungerer: \"When you buy 4 cards, give your Fodder +1/+1 and add 1 Fodder to your next tavern.\" · Members: Korok, the Hungerer · Moonhowl Mentor · Banksly · Brightwing Broker · Night Market Horror · Ayves · Ninefold Broker",
  ...
  },
  {
    ...
    "title": "Trigger: this minion Consumes something · 2 cards",
    "statement": "All 2 of these fire on one trigger: this minion Consumes something. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "2 effect factories across 2 cards dispatch on 'onConsume' (recruit) — re-clustered by TRIGGER out of the 'react' presentation family on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Avarice Incarnate: \"The first time another friendly Demon Consumes a Shop minion each turn, this gains the same stats and grants 3 Gold.\" · Members: Avarice Incarnate · Enigma",
    "example": "Avarice Incarnate fires when this minion Consumes something, like every other card here. its printed numbers double when the card is gilded.",
    "contentIds": [
      "dm_avarice",
      "dm_jumbo"
    ]
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "4 effect factories across 6 cards dispatch on 'friendlyDemonDealtDamage', 'onDamaged' (combat) — re-clustered by TRIGGER out of the 'react' presentation family on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Axeman: \"Critical Strike (50%). When a friendly Demon deals damage, gain +3/+3 permanently.\" · Members: Axeman · Leech · Impossible Todd · Gryphon · Candleback Bulwark · Target Dummy",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "6 effect factories across 6 cards dispatch on 'goldSpent' (recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Feastmaster Vhal: \"When you spend 10 Gold, give the right-most Shop minion +8/+8 permanently.\" · Members: Feastmaster Vhal · Billings · Dwarf King, Brill · Coinfire Forewoman · Mountainbond · Tapkeeper",
    "example": "Feastmaster Vhal fires when you spend Gold this turn, like every other card here. its printed numbers double when the card is gilded.",
    "contentIds": [
      "dm_vhal",
      "dw_billings",
      "dw_brill",
  ...
  },
  {
    ...
    "title": "Unrelated leftovers · 6 cards",
    "statement": "These 6 are unrelated: they share no trigger. Ruling each individually is the honest option. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "6 factories left over after the 'economy' + 'economyReact' families were re-clustered by trigger; they share NO trigger — 'onGainCard', 'shopRefreshed', 'spellCastOnThis', 'startOfTurn' (recruit). Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "No shared trigger: onGainCard · shopRefreshed · spellCastOnThis · startOfTurn · Members: Fel Conjurer · Mirrorwing · Hellrider · Gangplank · Kegheart Dwarf · Reflector",
    "example": "Fel Conjurer and the rest have nothing in common but leftover status — approving one statement over all of them would rule things you never read.",
    "contentIds": [
      "d2_felconjurer",
      "d2_mirrorwing",
      "dm_maw",
  ...
  },
  {
    ...
    "title": "Trigger: a Ruby is gained, played or cast · 6 cards",
    "statement": "All 6 of these fire on one trigger: a Ruby is gained, played or cast. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "6 effect factories across 6 cards dispatch on 'onGetRuby', 'onRubyPlayed', 'rubyCast' (both/recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Candle Conduit: \"When you get a Ruby, cast a Ruby on a random friendly minion.\" · Members: Candle Conduit · Gemgorge Fiend · Gem Sage · Resonance Idol · Ruby Broker · Reflector",
    "example": "Candle Conduit fires when a Ruby is gained, played or cast, like every other card here. its printed numbers double when the card is gilded.",
    "contentIds": [
      "k_candleconduit",
      "k_gemgorge",
      "k_gemsage",
  ...
  },
  {
    ...
    "title": "Trigger: you sell a card · 10 cards",
    "statement": "All 10 of these fire on one trigger: you sell a card. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "10 effect factories across 10 cards dispatch on 'minionSold', 'onSell' (recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Runic Archivist: \"After you sell 5 minions, get a Shop spell.\" · Members: Runic Archivist · River Drake · Voicekeeper · Arcane Behemoth · Grevlin & Co. · Hoard Whelp · Beggy · Cheap Date · Traveling Salesman · Salvatore McKlusky",
    "example": "Runic Archivist fires when you sell a card, like every other card here. its printed numbers double when the card is gilded.",
    "contentIds": [
      "d2_archivist",
      "d2_riverdrake",
      "d2_voicekeeper",
