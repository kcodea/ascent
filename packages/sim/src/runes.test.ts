...
describe('Runeforge — framework', () => {
  it('every rune validates + is Runeforge-only (never a card/quest id)', () => {
    ...
    expect(RUNES.length).toBe(150); // 141 → 142 on 2026-08-26: Happy Birthday (the Basic half of the Gift pair); 142 → 150 on 2026-09-16: Set 3 batch 2, tranche B (8 Basic)
