...
| **Rulebook** | 168 rules (82 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **168** live rules: **82** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
