...
const STD_KNOBS: Knob[] = [
  { key: 'sh', label: 'frame size', min: 0.5, max: 1.0, step: 0.01, def: 0.74 },
  { key: 'fill', label: 'art overfill', min: 1.0, max: 1.5, step: 0.01, def: 1.12 },
  ...
  { key: 'artY', label: 'art vert %', min: 0, max: 100, step: 1, def: 45, pct: true },
  { key: 'artZoom', label: 'art zoom', min: 0.8, max: 1.8, step: 0.01, def: 1.2 },
];
const SPELL_KNOBS: Knob[] = [
  { key: 'sh', label: 'frame size', min: 0.5, max: 1.0, step: 0.01, def: 0.76 },
  { key: 'fill', label: 'art overfill', min: 1.0, max: 1.5, step: 0.01, def: 1.05 },
  { key: 'dy', label: 'all Y', min: -0.1, max: 0.15, step: 0.005, def: 0.0 },
  { key: 'frameY', label: 'frame Y', min: -0.05, max: 0.15, step: 0.005, def: 0.0 },
  { key: 'tier', label: 'tier seat', min: 0.5, max: 1.0, step: 0.01, def: 0.82 },
  { key: 'artY', label: 'art vert %', min: 0, max: 100, step: 1, def: 42, pct: true },
  { key: 'artZoom', label: 'art zoom', min: 0.8, max: 1.8, step: 0.01, def: 1.0 },
  { key: 'artRound', label: 'corner round %', min: 0, max: 40, step: 1, def: 14, pct: true },
  { key: 'artAR', label: 'window height', min: 0.6, max: 1.4, step: 0.01, def: 0.963 },
  { key: 'artW', label: 'window width', min: 0.6, max: 1.2, step: 0.01, def: 1.0 },
];
