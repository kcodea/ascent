...
export const SPELLS: CardDef[] = [
  ...
  //     FRIENDLY minion: the grant only lands on the board it fights with (a tavern offer never enters combat). ---
  {
    ...
    effects: [],
    chooseOne: [
      { text: 'Give **Ward**.', effects: [{ on: 'cast', do: 'spellGrantKeywordNextCombat', params: { keyword: 'DS', label: 'Field Maneuvers' } }] },
      { text: 'Give **Flurry**.', effects: [{ on: 'cast', do: 'spellGrantKeywordNextCombat', params: { keyword: 'W', label: 'Field Maneuvers' } }] },
    ],
  ...
  },
  {
    ...
    cost: 2,
    target: 'friendly',
    effects: [{ on: 'cast', do: 'spellGrantKeywordNextCombat', params: { keyword: 'R', label: 'Last Stand' } }],
  ...
  },
  {
    ...
    cost: 2,
    target: 'friendly',
    effects: [{ on: 'cast', do: 'spellGrantKeywordNextCombat', params: { keyword: 'CR', critChance: 0.5, label: "Executioner's Edge" }, }],
  ...
  },
  {
    ...
    // plays as a normal minion from then on.
    id: 'funeralonloan',
  ...
  },
  {
    ...
    spell: true,
    cost: 2,
    effects: [{ on: 'cast', do: 'spellDecoyNextCombat', params: { count: 1 } }],
    text: 'Next combat, when you first have room, summon a **1/1 Training Dummy** with **Taunt** and **Ward** in the far right position.',
  },
  {
    id: 'weaken',
    name: 'Weaken',
    ...
    spell: true,
    cost: 3,
    effects: [{ on: 'cast', do: 'spellWeakenNextCombat', params: { count: 1 } }],
    text: "**Start of Combat:** set a random enemy's Health to **1**.",
  },
  {
    // Owner add 2026-08-19. A pre-combat setup spell: it buys nothing NOW, it arms the next fight. Banked on
    // the run rather than on a body, because the minions it pays out to have not been summoned yet.
    id: 'summoningbulwark',
    name: 'Summoning Bulwark',
    tribe: 'neutral',
    tier: 3,
    attack: 0,
    health: 1,
  ...
  },
  {
    ...
    spell: true,
    cost: 3,
    effects: [{ on: 'cast', do: 'spellGainSpellPower', params: { attack: 1, health: 1 } }],
    text: 'Give your **Shop spells +1/+1**.',
  },
