 ...
 *
 * Three tiers, one API:
 *  · APPROVED_RULES  — hand-authored, each on an explicit owner ruling, evidence cited; one file per domain
 *                      under registry/approved/ (the index concatenates them in a fixed order).
