...
| **Rulebook** | 184 rules (98 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **184** live rules: **98** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
