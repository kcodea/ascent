...
export const CONVENTION_PENDING: GameRule[] = [
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "21 effect factories across 21 cards dispatch through the 'avenge' presentation family, all on the single trigger 'avenge' (combat); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline, with Dunkey/Muster General/Steadfast Sentinel summoning a GILDED token at the same count, and Gemstorm Instigator buying one extra proc (owner ruling 2026-08-28).",
    "cardText": "Exemplar — Dunkey: \"Avenge (4): summon an Armadiyo.\" · Members: Dunkey · Solaris · Bone Taxer · Brood Matron · Totality · Grobbus · Kurse · Gemstorm Instigator · Gem Portsmith · Kennelmaster · Muster General · Pit Supplier · … and 9 more",
  ...
  },
  {
    ...
    "cardText": "Exemplar — Dunkey: \"Avenge (4): summon an Armadiyo.\" · Avenge carriers: Dunkey · Solaris · Bone Taxer · Brood Matron · Totality · Grobbus · Kurse · Gemstorm Instigator · Gem Portsmith · Kennelmaster · Muster General · Pit Supplier · … and 9 more",
