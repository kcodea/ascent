...
- **The first play of a run freezes for 0.6 – 0.8 s on BOTH builds.** A CPU profile of the branch's
  ...
  hero-select screen (or use `KHR_parallel_shader_compile`) and this disappears. Fixed the same day — see
  `2026-09-01-fx-shader-warmup.md` (the existing pre-warm had never run, and warmed the wrong context).
