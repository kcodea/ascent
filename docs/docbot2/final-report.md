...
| **Rulebook** | 178 rules (92 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **178** live rules: **92** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
