...
- **69** vitest lane files under `packages/sim/src/docbot/`.
...
| 14 | Mutation/sabotage tests demonstrate detection in every oracle family | **partial** | 31 of 69 docbot lanes carry an in-file sabotage proof, plus the retro harness's 14 reinjections; the remaining lanes are structural ratchets without one |
