...
export const DEATHRATTLE_BUFF_FACTORIES: ReadonlySet<string> = new Set([
  ...
  //   • `deathrattleGrantWardRandom` — Lastlight hands out Ward on death (a keyword, but it rides the
  ...
  'deathrattlePlayRubiesAdjacent', 'deathrattlePlayRubiesTribe', 'deathrattleSummonGolemsWithRuby', 'deathrattleGrantWardRandom',
