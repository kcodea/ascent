...
const SPECS: Record<keyof HscTunerConfig, [string, TunerUnit | undefined, string, string]> = {
  ...
  nameY:             ['Name vertical', 'px', 'Negative lifts the plate (both lines) toward the portrait.', 'Name'],
  ...
  powerY:            ['Power vertical', 'px', 'Negative lifts the power name toward the hero name. Track it with the plate.', 'Power name'],
