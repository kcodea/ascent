/**
 * GENERATED by `npm run contracts:extract` — do not hand-edit. 75 convention questions
...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "title": "'castReact' family · 10 cards",
    "statement": "All 10 'castReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "13 effect factories across 10 cards dispatch through the 'castReact' presentation family, all on the single trigger 'spellCast' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Gravestar Seer: \"Whenever you cast a spell, this gains +4 Attack permanently.\" · Members: Gravestar Seer · Astral Spellcore · Zenith · Earthbreaker · Goldilox · Forsaken Mage · Archmagus Guel · Fatecarver · Runescale Drake · Lullaby Lou",
  ...
  },
  {
    ...
    "title": "'endOfTurn' family · 28 cards",
    ...
    "cardText": "Exemplar — Abyssal Feeder: \"End of Turn: adjacent minions each Consume a Fodder.\" · Members: Abyssal Feeder · Aeon Guard · Stonehorn Archivist · Roundabout · Combinator · Crypt Scribe · Skybound Ascendant · Soul Defiler · Bob Blart · Striker · Arnold · Brunni · … and 16 more",
  ...
  },
  {
    ...
    "title": "'summonReact' family · 14 cards",
    "statement": "All 14 'summonReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "16 effect factories across 14 cards dispatch through the 'summonReact' presentation family, all on the single trigger 'onSummon' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
  ...
  },
  {
    ...
    "title": "Dual & universal tribes · 25 carriers",
    ...
    "cardText": "Exemplar — Bane: \"After you trigger a Shout, give your Imps +3/+3 this run.\" · Carriers: Bane · Gravestar Seer · Crypt Drake · Crypt Wolf · Fel Conjurer · Goldilox · Han Gover · Baal · High King Mykel · Mountainbond · Heckbinder · Kurse · … and 13 more",
  ...
  },
  {
    ...
    "id": "q-conv-keyword-rw",
    "title": "Resilient Ward [RW] · 0 carriers",
    "statement": "Resilient Ward means: a Ward that takes 2 hits to break: the first hit is absorbed and leaves a plain Ward, the second breaks it; carried alongside Ward (DS) — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "keywords",
    "currentBehaviour": "One shared engine path implements Resilient Ward for all 0 carriers.",
    "cardText": "(no current carrier of Resilient Ward)",
    "example": "any future Resilient Ward card inherits this meaning."
  },
  {
    "status": "needs-ruling",
    "evidence": [
  ...
  },
  {
    ...
    "cardText": "Exemplar — Armadiyo: \"Taunt. Echo: give your Beast Aura +2/+4.\" · Carriers: Armadiyo · Dawnclaw · Wolvie · Blaster · Dawn Sentinel · Fel Spikes · Chipper · Knocked · Big Huggies · Brunni · Twilight Emissary · Gryphon · … and 9 more",
  ...
  },
  {
    ...
    "title": "Trigger: you buy a card · 5 cards",
    "statement": "All 5 of these fire on one trigger: you buy a card. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "7 effect factories across 5 cards dispatch on 'cardsBought', 'onBuy', 'spellBought' (recruit) — re-clustered by TRIGGER out of the 'economy' + 'economyReact' presentation families on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Korok, the Hungerer: \"When you buy 4 cards, give your Fodder +1/+1 and add 1 Fodder to your next tavern.\" · Members: Korok, the Hungerer · Banksly · Brightwing Broker · Night Market Horror · Ninefold Broker",
  ...
  },
  {
    ...
    "id": "q-conv-trigger-starform",
    "title": "Trigger: your Starform gains stats or leaves the Shop · 2 cards",
    ...
    "cardText": "Exemplar — Twinning: \"Whenever your Starform gains stats, this does, too.\" · Members: Twinning · Zenith",
    "example": "Twinning fires when your Starform gains stats or leaves the Shop, like every other card here. its printed numbers double when the card is gilded.",
    "contentIds": [
      "ce3_twinstar",
      "ce3_zenith"
    ]
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "3 effect factories across 2 cards dispatch on 'startOfTurn' (recruit) — re-clustered by TRIGGER out of the 'economy' presentation family on the owner's 2026-08-28 ruling; the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Fel Conjurer: \"Start of Turn: get a Quick Study.\" · Members: Fel Conjurer · Jumpstart Jules",
