...
| **Rulebook** | 171 rules (85 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **171** live rules: **85** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
