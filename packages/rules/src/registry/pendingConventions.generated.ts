...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "title": "'castReact' family · 8 cards",
    "statement": "All 8 'castReact' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "11 effect factories across 8 cards dispatch through the 'castReact' presentation family, all on the single trigger 'spellCast' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Gravestar Seer: \"Whenever you cast a spell, this gains +4 Attack permanently.\" · Members: Gravestar Seer · Astral Spellcore · Earthbreaker · Forsaken Mage · Archmagus Guel · Fatecarver · Runescale Drake · Dreamcurrent Mystic",
  ...
  },
  {
    ...
    "title": "'grant' family · 14 cards",
    "statement": "All 14 'grant' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "1 effect factories across 14 cards dispatch through the 'grant' presentation family, all on the single trigger 'equip' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Orrery Artificer: \"Equip Comet (4): your next spell casts 2 additional times.\" · Members: Orrery Artificer · Pourman · Thymes · Alchemist Frank · Titan Sculptor · Blast Surveyor · Kaura L'roft · Prismpick Artificer · Highway Hustler · Inspector Pell · Bondweaver Shaman · Spirit Artificer · … and 2 more",
  ...
  },
  {
    ...
    "title": "'shout' family · 61 cards",
    "statement": "All 61 'shout' cards trigger the same way. Gilding doubles their output. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "57 effect factories across 61 cards dispatch through the 'shout' presentation family, all on the single trigger 'onPlay' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline; any member whose gild changes shape instead carries authored golden text (R-GILD-01).",
    "cardText": "Exemplar — Pennycat: \"Battlecry: summon a 1/1 Stray next to it.\" · Members: Pennycat · Mage-Pup · Black Belt Brian · Buddy Buddy · Falling Star Herald · Starpath Vendor · Cinderwing Matron · Hoard Cleric · Crypt Broker · Commander Warpath · Broodfire · Brood Whelp · … and 49 more",
  ...
  },
  {
    ...
    "domain": "triggers",
    "currentBehaviour": "100 effect factories across 107 cards dispatch through the 'spellCast' presentation family, all on the single trigger 'cast' (recruit); the factoryPhase lane gates each (trigger, factory) pair. Gilding: INAPPLICABLE — checkTriples skips spells and Rubies, so no member of this family can ever BE gilded (R-GILD-02, owner ruling 2026-08-28).",
    "cardText": "Exemplar — Anomaly Reactor: \"Give a friendly minion All types — it counts as every tribe and gets all of their buffs.\" · Members: Anomaly Reactor · Eyes of Aresmar · Bloodlust · Bulwark · Carnival Coin · Chrono Staff · Clue · Common Ground · Consume · Copycat · Crescendo · Cupcakes · … and 95 more",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "342 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
