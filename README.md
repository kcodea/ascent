...
- **Karwind reworked** — flat +3/+3 to every Dragon on a Shout trigger, with a 20% chance to double, announced by a crit-style "2x" that floats above him. Seeded on both sides, so replays crit identically.
