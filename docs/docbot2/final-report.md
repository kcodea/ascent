...
| **Rulebook** | 170 rules (84 approved) | — | `enforcement.test.ts` — every approved rule names a backing lane file that must exist on disk |
...
- **170** live rules: **84** hand-authored approved (`registry/approved.ts`), the rest the owner's seeded
