/**
 * GENERATED by `npm run contracts:extract` — do not hand-edit. 73 convention questions
...
export const CONVENTION_PENDING: GameRule[] = [
  ...
  },
  {
    ...
    "title": "'echo' family · 69 cards",
    "statement": "All 69 'echo' cards trigger the same way. Gilding doubles their output; a few summon a gilded token instead. — ✓ yes · ✕ no (say why) · ✎ your wording",
    "domain": "triggers",
    "currentBehaviour": "50 effect factories across 69 cards dispatch through the 'echo' presentation family, all on the single trigger 'onDeath' (both); the factoryPhase lane gates each (trigger, factory) pair. Gilding: the ×2 baseline is the safe reading, with Void Panther / T-Rex / Chicken Brawl gilding the token they summon instead of doubling the count (owner ruling 2026-08-28).",
    "cardText": "Exemplar — Amun Rab: \"Deathrattle: Summon 7 Imps and give your Imps +5/+5.\" · Members: Amun Rab · Anubis, Last Gate · Ashen Heir · Armadiyo · Bullseye · Dawnclaw · Menagerie Mammoth · T-Rex · Voidmother · Wolvie · Blaster · Bone Taxer · … and 57 more",
  ...
  },
  {
    ...
    "cardText": "Exemplar — Accretion: \"Your Starform consumes the highest-Health minion in the Shop. Get a Star Crash.\" · Members: Accretion · Anomaly Reactor · Eyes of Aresmar · Bloodlust · Bulwark · Carnival Coin · Chrono Staff · Clue · Common Ground · Consume · Copycat · Crescendo · … and 96 more",
    "example": "Accretion follows the 'spellCast' convention — its trigger fires on cast. three copies of it never combine into a golden one, so it has no gilded form at all.",
    "contentIds": [
      "accretion",
      "anomalyreactor",
      "aresmar",
  ...
  },
  {
    ...
    "domain": "gilding",
    "currentBehaviour": "358 cards carry authored goldenText; every other card inherits the ×2 number-doubler. The outlier shapes are the owner's 2026-08-28 rulings, now carried per card as the contract's gildedDelta kind (R-GILD-01); spells and Rubies are not-applicable (R-GILD-02).",
  ...
  },
  {
    ...
    "title": "Threshold counters · 20 Avenge carriers",
  ...
  },
  {
    ...
    "cardText": "Exemplar — Shooting Star: \"Flurry. Shout: give this shop +3/+3 for each Shop spell you cast this turn.\" · Carriers: Shooting Star · Commander Impala · Blazer · Speedy · Tauntbreaker",
    "example": "Shooting Star carries Windfury — in play, attacks twice per attack turn.",
    "contentIds": [
      "ce3_shootingstar",
      "impala",
      "k_blazer",
