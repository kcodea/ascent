...
export const QUEST_DEFS: QuestDef[] = [
  ...
  { id: 'q_blood_trail', name: 'Blood Trail', tribe: 'beast', tier: 'lesser', objective: { event: 'slaughter', count: 6 }, reward: { kind: 'combatFlag', flag: 'bloodTrail' } },
  ...
  { id: 'q_shop_license', name: 'Shop License', tribe: 'neutral', tier: 'lesser', objective: { event: 'spendGold', count: 15 }, reward: { kind: 'gainMaxGold', amount: 2 } },
  ...
  { id: 'q_epic_commission', name: 'Epic Commission', tribe: 'neutral', tier: 'greater', objective: { event: 'spendGold', count: 25 }, reward: { kind: 'openEpicRuneforge' } },
  ...
  { id: 'q_echo_chamber', name: 'Echo Chamber', tribe: 'neutral', tier: 'greater', objective: { event: 'summonCombat', count: 12 }, reward: { kind: 'grant', cards: ['echowarden'] } },
  ...
  { id: 'q_dupes', name: 'Dupes', tribe: 'neutral', tier: 'greater', objective: { event: 'winRound', count: 3 }, reward: { kind: 'dupeFirstBuy' } },
  ...
  { id: 'q_ancient_runes', name: 'Ancient Runes', tribe: 'neutral', tier: 'greater', objective: { event: 'spendGold', count: 50 }, reward: { kind: 'spellRepeat', scope: 'always' } },
  ...
  { id: 'q_machine_chorus', name: 'Machine Chorus', tribe: 'mech', tier: 'capstone', objective: { event: 'rally', count: 6 }, reward: { kind: 'grant', cards: ['chorusengine'] } },
  ...
  { id: 'q_attachment_issues', name: 'Attachment Issues', tribe: 'mech', tier: 'capstone', objective: { event: 'slaughter', count: 14 }, reward: { kind: 'attachmentDeal', cost: 2 } },
  ...
  { id: 'q_pit_without_end', name: 'Pit Without End', tribe: 'demon', tier: 'capstone', objective: { event: 'summonImp', count: 17 }, reward: { kind: 'combatFlag', flag: 'pitWithoutEnd', amount: 3 } },
